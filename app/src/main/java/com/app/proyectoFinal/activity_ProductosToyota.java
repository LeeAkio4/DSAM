...
public class activity_ProductosToyota extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_productos_toyota);  // Cambia el nombre del layout si es necesario
        ...
        Button btnAtrasProductos = findViewById(R.id.btnAtrasProducToyota);  // Cambia el ID del botón si es necesario
        btnAtrasProductos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Cambiar a la nueva actividad
                Intent intent = new Intent(activity_ProductosToyota.this, Menu_Marcas.class);  // Cambia el nombre de la actividad si es necesario
        ...
        // Ordenar la lista para que los productos de la marca 'Toyota' aparezcan primero
        Collections.sort(listaProductos, new Comparator<Producto>() {
            ...
            public int compare(Producto p1, Producto p2) {
                ...
                return 0; // Si ambas marcas son iguales o no son 'Toyota', no se cambia el orden
            }
        });
    ...
    public class ProductoAdapter extends RecyclerView.Adapter<ProductoAdapter.ProductoViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ProductoViewHolder holder, int position) {
            ...
            // Filtrar para mostrar solo los productos de la marca 'Toyota'
            if (producto.getMarca().equalsIgnoreCase("Toyota")) {
                ...
                // Si no es de la marca 'Toyota', lo ocultamos
