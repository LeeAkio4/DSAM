...
public class activity_ProductosSuzuki extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ordenar los productos para que 'Suzuki' aparezca primero
    ...
    public class ProductoAdapter extends RecyclerView.Adapter<activity_ProductosSuzuki.ProductoAdapter.ProductoViewHolder> {
        ...
        @NonNull
        @Override
        public activity_ProductosSuzuki.ProductoAdapter.ProductoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_producto, parent, false);
            return new activity_ProductosSuzuki.ProductoAdapter.ProductoViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull activity_ProductosSuzuki.ProductoAdapter.ProductoViewHolder holder, int position) {
