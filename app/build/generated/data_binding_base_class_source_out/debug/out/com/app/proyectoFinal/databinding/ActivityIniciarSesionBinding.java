...
public final class ActivityIniciarSesionBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputEditText IdContraseA;

  @NonNull
  public final TextInputEditText IdCorreo;
  ...
  private ActivityIniciarSesionBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextInputEditText IdContraseA, @NonNull TextInputEditText IdCorreo,
      @NonNull Button btnLogin, @NonNull Button btnsalir, @NonNull ImageView imageView2,
  ...
  public static ActivityIniciarSesionBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.IdContraseña;
      TextInputEditText IdContraseA = ViewBindings.findChildViewById(rootView, id);
      if (IdContraseA == null) {
        break missingId;
      }

      id = R.id.IdCorreo;
      TextInputEditText IdCorreo = ViewBindings.findChildViewById(rootView, id);
      if (IdCorreo == null) {
        break missingId;
      }
      ...
      return new ActivityIniciarSesionBinding((ConstraintLayout) rootView, IdContraseA, IdCorreo,
          btnLogin, btnsalir, imageView2, imageView5, linearLayout, main, textInputLayout,
