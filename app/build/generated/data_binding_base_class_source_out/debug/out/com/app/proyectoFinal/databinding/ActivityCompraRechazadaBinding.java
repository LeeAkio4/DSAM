...
public final class ActivityCompraRechazadaBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCompraRechazadaBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityCompraRechazadaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCompraRechazadaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_compra_rechazada, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCompraRechazadaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCompraRechazadaBinding((ConstraintLayout) rootView, buttonPrint,
